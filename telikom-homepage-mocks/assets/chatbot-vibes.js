(()=>{
  ...
  css.textContent=`
  #tk-production-chat{position:fixed!important;right:20px!important;bottom:20px!important;width:58px!important;height:58px!important;z-index:2147483647!important;font-family:Inter,Arial,sans-serif!important;color:#173247!important;line-height:1.4!important}
  #tk-production-chat *{box-sizing:border-box!important}
  #tk-production-chat .tk-window{position:absolute!important;right:0!important;bottom:70px!important;display:none!important;width:360px!important;max-width:calc(100vw - 28px)!important;max-height:min(610px,calc(100vh - 105px))!important;background:#fff!important;border:1px solid rgba(17,59,83,.13)!important;border-radius:${t.radius}!important;box-shadow:0 24px 70px rgba(4,31,48,.26)!important;overflow:hidden!important}
